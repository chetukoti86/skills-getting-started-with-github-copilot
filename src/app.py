...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team for intramural and inter-school play",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu"]
    },
    "Tennis Club": {
        "description": "Tennis lessons and court play for all skill levels",
    ...
    "Music Band": {
        "description": "Learn and perform music in a school band setting",
        "schedule": "Mondays, Thursdays, 4:00 PM - 5:00 PM",
        "max_participants": 25,
